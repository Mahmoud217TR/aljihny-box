...
final class CreateUSDSellTransactionAction
{
    ...
    public function execute(
        ...
        return DB::transaction(function () use ($cashbox, $conversion, $at) {
            $transaction = Transaction::create([
                'description' => __("Sold USD to :cashbox", [
            ...
            $this->createEntryAction->execute($transaction, $cashbox, EntryType::Debit, $conversion->to);

            $this->createEntryAction->execute($transaction, Account::findByCode(1200), EntryType::Credit, $conversion->from);
